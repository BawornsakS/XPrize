...
#include "turtlesim/srv/spawn__rosidl_typesupport_opensplice_c.h"
#include "rmw/rmw.h"
...
#include "turtlesim/srv/dds_opensplice/spawn__type_support.cpp"
...
using __dds_msg_type_turtlesim__srv__Spawn_Request = turtlesim::srv::dds_::Spawn_Request_;
using __ros_msg_type_turtlesim__srv__Spawn_Request = turtlesim__srv__Spawn_Request;

static turtlesim::srv::dds_::Spawn_Request_TypeSupport _type_support_turtlesim__srv__Spawn_Request;

static const char *
register_type_turtlesim__srv__Spawn_Request(void * untyped_participant, const char * type_name)
{
  ...
  DDS::ReturnCode_t status = _type_support_turtlesim__srv__Spawn_Request.register_type(participant, type_name);
  switch (status) {
...
static const char *
convert_ros_to_dds_turtlesim__srv__Spawn_Request(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const __ros_msg_type_turtlesim__srv__Spawn_Request * ros_message = static_cast<const __ros_msg_type_turtlesim__srv__Spawn_Request *>(untyped_ros_message);
  __dds_msg_type_turtlesim__srv__Spawn_Request * dds_message = static_cast<__dds_msg_type_turtlesim__srv__Spawn_Request *>(untyped_dds_message);
  // Field name: x
  {
...
static const char *
publish_turtlesim__srv__Spawn_Request(void * dds_data_writer, const void * ros_message)
{
  if (!dds_data_writer) {
  ...
  __dds_msg_type_turtlesim__srv__Spawn_Request dds_message;
  const char * err_msg = convert_ros_to_dds_turtlesim__srv__Spawn_Request(ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }
...
static const char *
convert_dds_to_ros_turtlesim__srv__Spawn_Request(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    return "ros message handle is null";
  }
  ...
  const __dds_msg_type_turtlesim__srv__Spawn_Request * dds_message = static_cast<const __dds_msg_type_turtlesim__srv__Spawn_Request *>(untyped_dds_message);
  __ros_msg_type_turtlesim__srv__Spawn_Request * ros_message = static_cast<__ros_msg_type_turtlesim__srv__Spawn_Request *>(untyped_ros_message);
  // Field name: x
  {
...
static const char *
take_turtlesim__srv__Spawn_Request(
  ...
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    errs = convert_dds_to_ros_turtlesim__srv__Spawn_Request(&dds_messages[0], untyped_ros_message);
    if (errs != 0) {
      goto finally;
    }
    *taken = true;
...
static const char *
serialize_turtlesim__srv__Spawn_Request(
  ...
  void * untyped_serialized_data)
{
  ...
  __dds_msg_type_turtlesim__srv__Spawn_Request dds_message;
  const char * err_msg = convert_ros_to_dds_turtlesim__srv__Spawn_Request(untyped_ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }

  DDS::OpenSplice::CdrTypeSupport cdr_ts(_type_support_turtlesim__srv__Spawn_Request);
...
static const char *
deserialize_turtlesim__srv__Spawn_Request(
  ...
  void * untyped_ros_message)
{
  ...
  errs = convert_dds_to_ros_turtlesim__srv__Spawn_Request(&dds_message, untyped_ros_message);

  return errs;
}


static message_type_support_callbacks_t Spawn_Request__callbacks = {
  "turtlesim::srv",  // message_namespace
  "Spawn_Request",  // message_name
  register_type_turtlesim__srv__Spawn_Request,  // register_type
  publish_turtlesim__srv__Spawn_Request,  // publish
  take_turtlesim__srv__Spawn_Request,  // take
  serialize_turtlesim__srv__Spawn_Request,  // serialize message
  deserialize_turtlesim__srv__Spawn_Request,  // deserialize message
  convert_ros_to_dds_turtlesim__srv__Spawn_Request,  // convert_ros_to_dds
  convert_dds_to_ros_turtlesim__srv__Spawn_Request,  // convert_dds_to_ros
};

static rosidl_message_type_support_t Spawn_Request__type_support = {
  rosidl_typesupport_opensplice_c__identifier,
  &Spawn_Request__callbacks,  // data
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  Spawn_Request)()
{
  return &Spawn_Request__type_support;
}
...
using __dds_msg_type_turtlesim__srv__Spawn_Response = turtlesim::srv::dds_::Spawn_Response_;
using __ros_msg_type_turtlesim__srv__Spawn_Response = turtlesim__srv__Spawn_Response;

static turtlesim::srv::dds_::Spawn_Response_TypeSupport _type_support_turtlesim__srv__Spawn_Response;

static const char *
register_type_turtlesim__srv__Spawn_Response(void * untyped_participant, const char * type_name)
{
  if (!untyped_participant) {
    return "untyped participant handle is null";
  }
  ...
  DDS::ReturnCode_t status = _type_support_turtlesim__srv__Spawn_Response.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
...
static const char *
convert_ros_to_dds_turtlesim__srv__Spawn_Response(const void * untyped_ros_message, void * untyped_dds_message)
{
  if (!untyped_ros_message) {
    return "ros message handle is null";
  }
  ...
  const __ros_msg_type_turtlesim__srv__Spawn_Response * ros_message = static_cast<const __ros_msg_type_turtlesim__srv__Spawn_Response *>(untyped_ros_message);
  __dds_msg_type_turtlesim__srv__Spawn_Response * dds_message = static_cast<__dds_msg_type_turtlesim__srv__Spawn_Response *>(untyped_dds_message);
  // Field name: name
  {
    const rosidl_generator_c__String * str = &ros_message->name;
    if (!str) {
...
static const char *
publish_turtlesim__srv__Spawn_Response(void * dds_data_writer, const void * ros_message)
{
  if (!dds_data_writer) {
    return "data writer handle is null";
  }
  ...
  __dds_msg_type_turtlesim__srv__Spawn_Response dds_message;
  const char * err_msg = convert_ros_to_dds_turtlesim__srv__Spawn_Response(ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }
...
static const char *
convert_dds_to_ros_turtlesim__srv__Spawn_Response(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    return "ros message handle is null";
  }
  ...
  const __dds_msg_type_turtlesim__srv__Spawn_Response * dds_message = static_cast<const __dds_msg_type_turtlesim__srv__Spawn_Response *>(untyped_dds_message);
  __ros_msg_type_turtlesim__srv__Spawn_Response * ros_message = static_cast<__ros_msg_type_turtlesim__srv__Spawn_Response *>(untyped_ros_message);
  // Field name: name
  {
    if (!ros_message->name.data) {
      rosidl_generator_c__String__init(&ros_message->name);
...
static const char *
take_turtlesim__srv__Spawn_Response(
  void * dds_data_reader,
  bool ignore_local_publications,
  void * untyped_ros_message,
  bool * taken,
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    errs = convert_dds_to_ros_turtlesim__srv__Spawn_Response(&dds_messages[0], untyped_ros_message);
    if (errs != 0) {
      goto finally;
    }
    *taken = true;
...
static const char *
serialize_turtlesim__srv__Spawn_Response(
  const void * untyped_ros_message,
  void * untyped_serialized_data)
{
  if (!untyped_ros_message) {
  ...
  __dds_msg_type_turtlesim__srv__Spawn_Response dds_message;
  const char * err_msg = convert_ros_to_dds_turtlesim__srv__Spawn_Response(untyped_ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }

  DDS::OpenSplice::CdrTypeSupport cdr_ts(_type_support_turtlesim__srv__Spawn_Response);
...
static const char *
deserialize_turtlesim__srv__Spawn_Response(
  const uint8_t * buffer,
  unsigned length,
  void * untyped_ros_message)
{
  ...
  errs = convert_dds_to_ros_turtlesim__srv__Spawn_Response(&dds_message, untyped_ros_message);

  return errs;
}


static message_type_support_callbacks_t Spawn_Response__callbacks = {
  "turtlesim::srv",  // message_namespace
  "Spawn_Response",  // message_name
  register_type_turtlesim__srv__Spawn_Response,  // register_type
  publish_turtlesim__srv__Spawn_Response,  // publish
  take_turtlesim__srv__Spawn_Response,  // take
  serialize_turtlesim__srv__Spawn_Response,  // serialize message
  deserialize_turtlesim__srv__Spawn_Response,  // deserialize message
  convert_ros_to_dds_turtlesim__srv__Spawn_Response,  // convert_ros_to_dds
  convert_dds_to_ros_turtlesim__srv__Spawn_Response,  // convert_dds_to_ros
};

static rosidl_message_type_support_t Spawn_Response__type_support = {
  rosidl_typesupport_opensplice_c__identifier,
  &Spawn_Response__callbacks,  // data
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  Spawn_Response)()
{
  return &Spawn_Response__type_support;
}
...
// forward declare type support functions
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, turtlesim, srv, Spawn_Request)();
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, turtlesim, srv, Spawn_Response)();

const char *
register_types__turtlesim__srv__Spawn(
  void * untyped_participant, const char * request_type_name, const char * response_type_name)
{
  return turtlesim::srv::typesupport_opensplice_cpp::register_types__Spawn(
    untyped_participant, request_type_name, response_type_name);
}

const char *
create_requester__turtlesim__srv__Spawn(
...
{
  return turtlesim::srv::typesupport_opensplice_cpp::create_requester__Spawn(
...
const char *
create_responder__turtlesim__srv__Spawn(
  void * untyped_participant, const char * service_name,
  ...
  void * (*allocator)(size_t))
{
  return turtlesim::srv::typesupport_opensplice_cpp::create_responder__Spawn(
    untyped_participant, service_name,
...
const char *
send_request__turtlesim__srv__Spawn(
...
const char *
take_request__turtlesim__srv__Spawn(
...
const char *
send_response__turtlesim__srv__Spawn(
...
const char *
take_response__turtlesim__srv__Spawn(
...
const char *
destroy_requester__turtlesim__srv__Spawn(void * untyped_requester, void (* deallocator)(void *))
{
  return turtlesim::srv::typesupport_opensplice_cpp::destroy_requester__Spawn(
    untyped_requester, deallocator);
}

const char *
destroy_responder__turtlesim__srv__Spawn(void * untyped_responder, void (* deallocator)(void *))
{
  return turtlesim::srv::typesupport_opensplice_cpp::destroy_responder__Spawn(
    untyped_responder, deallocator);
}

const char *
server_is_available__turtlesim__srv__Spawn(
  void * requester, const rmw_node_t * node, bool * is_available)
{
  return turtlesim::srv::typesupport_opensplice_cpp::server_is_available__Spawn(
...
static service_type_support_callbacks_t Spawn__callbacks = {
  ...
  "Spawn",
  &create_requester__turtlesim__srv__Spawn,
  &destroy_requester__turtlesim__srv__Spawn,
  &create_responder__turtlesim__srv__Spawn,
  &destroy_responder__turtlesim__srv__Spawn,
  &send_request__turtlesim__srv__Spawn,
  &take_request__turtlesim__srv__Spawn,
  &send_response__turtlesim__srv__Spawn,
  &take_response__turtlesim__srv__Spawn,
...
static rosidl_service_type_support_t Spawn__type_support = {
  rosidl_typesupport_opensplice_c__identifier,
  &Spawn__callbacks,  // data
  get_service_typesupport_handle_function,
};

const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, turtlesim, srv, Spawn)() {
  return &Spawn__type_support;
}
