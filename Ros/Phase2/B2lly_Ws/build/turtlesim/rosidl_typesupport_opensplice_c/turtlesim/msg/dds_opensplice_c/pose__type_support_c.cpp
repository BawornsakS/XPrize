...
#include "turtlesim/msg/pose__rosidl_typesupport_opensplice_c.h"
...
using __dds_msg_type_turtlesim__msg__Pose = turtlesim::msg::dds_::Pose_;
using __ros_msg_type_turtlesim__msg__Pose = turtlesim__msg__Pose;

static turtlesim::msg::dds_::Pose_TypeSupport _type_support_turtlesim__msg__Pose;

static const char *
register_type_turtlesim__msg__Pose(void * untyped_participant, const char * type_name)
{
  ...
  DDS::ReturnCode_t status = _type_support_turtlesim__msg__Pose.register_type(participant, type_name);
  switch (status) {
...
static const char *
convert_ros_to_dds_turtlesim__msg__Pose(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const __ros_msg_type_turtlesim__msg__Pose * ros_message = static_cast<const __ros_msg_type_turtlesim__msg__Pose *>(untyped_ros_message);
  __dds_msg_type_turtlesim__msg__Pose * dds_message = static_cast<__dds_msg_type_turtlesim__msg__Pose *>(untyped_dds_message);
  // Field name: x
  {
...
static const char *
publish_turtlesim__msg__Pose(void * dds_data_writer, const void * ros_message)
{
  if (!dds_data_writer) {
  ...
  __dds_msg_type_turtlesim__msg__Pose dds_message;
  const char * err_msg = convert_ros_to_dds_turtlesim__msg__Pose(ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }
...
static const char *
convert_dds_to_ros_turtlesim__msg__Pose(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    return "ros message handle is null";
  }
  ...
  const __dds_msg_type_turtlesim__msg__Pose * dds_message = static_cast<const __dds_msg_type_turtlesim__msg__Pose *>(untyped_dds_message);
  __ros_msg_type_turtlesim__msg__Pose * ros_message = static_cast<__ros_msg_type_turtlesim__msg__Pose *>(untyped_ros_message);
  // Field name: x
  {
  ...
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    errs = convert_dds_to_ros_turtlesim__msg__Pose(&dds_messages[0], untyped_ros_message);
    if (errs != 0) {
      goto finally;
    }
    *taken = true;
...
static const char *
serialize_turtlesim__msg__Pose(
  ...
  void * untyped_serialized_data)
{
  ...
  __dds_msg_type_turtlesim__msg__Pose dds_message;
  const char * err_msg = convert_ros_to_dds_turtlesim__msg__Pose(untyped_ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }

  DDS::OpenSplice::CdrTypeSupport cdr_ts(_type_support_turtlesim__msg__Pose);
...
static const char *
deserialize_turtlesim__msg__Pose(
  ...
  void * untyped_ros_message)
{
  ...
  errs = convert_dds_to_ros_turtlesim__msg__Pose(&dds_message, untyped_ros_message);

  return errs;
}


static message_type_support_callbacks_t Pose__callbacks = {
  "turtlesim::msg",  // message_namespace
  "Pose",  // message_name
  register_type_turtlesim__msg__Pose,  // register_type
  publish_turtlesim__msg__Pose,  // publish
  take_turtlesim__msg__Pose,  // take
  serialize_turtlesim__msg__Pose,  // serialize message
  deserialize_turtlesim__msg__Pose,  // deserialize message
  convert_ros_to_dds_turtlesim__msg__Pose,  // convert_ros_to_dds
  convert_dds_to_ros_turtlesim__msg__Pose,  // convert_dds_to_ros
};

static rosidl_message_type_support_t Pose__type_support = {
  rosidl_typesupport_opensplice_c__identifier,
  &Pose__callbacks,  // data
