...
#include "turtlesim/srv/teleport_relative__rosidl_typesupport_opensplice_cpp.hpp"
...
using __dds_msg_type_TeleportRelative_Request = turtlesim::srv::dds_::TeleportRelative_Request_;
using __ros_msg_type_TeleportRelative_Request = turtlesim::srv::TeleportRelative_Request;

static turtlesim::srv::dds_::TeleportRelative_Request_TypeSupport __type_support_TeleportRelative_Request;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_turtlesim
const char *
register_type__TeleportRelative_Request(
  ...
  const char * type_name)
{
  ...
  DDS::ReturnCode_t status = __type_support_TeleportRelative_Request.register_type(participant, type_name);
  switch (status) {
...
convert_ros_message_to_dds(
  const __ros_msg_type_TeleportRelative_Request & ros_message,
  __dds_msg_type_TeleportRelative_Request & dds_message)
{
  // member.name linear
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_turtlesim
const char *
publish__TeleportRelative_Request(
  void * untyped_topic_writer,
  const void * untyped_ros_message)
{
  DDS::DataWriter * topic_writer = static_cast<DDS::DataWriter *>(untyped_topic_writer);

  const __ros_msg_type_TeleportRelative_Request & ros_message = *static_cast<const __ros_msg_type_TeleportRelative_Request *>(untyped_ros_message);
  __dds_msg_type_TeleportRelative_Request dds_message;
...
convert_dds_message_to_ros(
  const __dds_msg_type_TeleportRelative_Request & dds_message,
  __ros_msg_type_TeleportRelative_Request & ros_message)
{
  // member.name linear
  ros_message.linear =
    dds_message.linear_;
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_turtlesim
const char *
take__TeleportRelative_Request(
  ...
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    __ros_msg_type_TeleportRelative_Request & ros_message = *static_cast<__ros_msg_type_TeleportRelative_Request *>(untyped_ros_message);
  ...
  void * untyped_serialized_data)
{
  ...
  DDS::OpenSplice::CdrTypeSupport cdr_ts(__type_support_TeleportRelative_Request);
...
static message_type_support_callbacks_t TeleportRelative_Request_callbacks = {
  "turtlesim::srv",
...
static rosidl_message_type_support_t TeleportRelative_Request_handle = {
  rosidl_typesupport_opensplice_cpp::typesupport_identifier,
  &TeleportRelative_Request_callbacks,
...
{
  return &turtlesim::srv::typesupport_opensplice_cpp::TeleportRelative_Request_handle;
}
...
using __dds_msg_type_TeleportRelative_Response = turtlesim::srv::dds_::TeleportRelative_Response_;
using __ros_msg_type_TeleportRelative_Response = turtlesim::srv::TeleportRelative_Response;

static turtlesim::srv::dds_::TeleportRelative_Response_TypeSupport __type_support_TeleportRelative_Response;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_turtlesim
const char *
register_type__TeleportRelative_Response(
  void * untyped_participant,
  const char * type_name)
{
  if (!untyped_participant) {
  ...
  DDS::ReturnCode_t status = __type_support_TeleportRelative_Response.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
...
void
convert_ros_message_to_dds(
  const __ros_msg_type_TeleportRelative_Response & ros_message,
  __dds_msg_type_TeleportRelative_Response & dds_message)
{
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_turtlesim
const char *
publish__TeleportRelative_Response(
  void * untyped_topic_writer,
  const void * untyped_ros_message)
{
  DDS::DataWriter * topic_writer = static_cast<DDS::DataWriter *>(untyped_topic_writer);

  const __ros_msg_type_TeleportRelative_Response & ros_message = *static_cast<const __ros_msg_type_TeleportRelative_Response *>(untyped_ros_message);
  __dds_msg_type_TeleportRelative_Response dds_message;
  convert_ros_message_to_dds(ros_message, dds_message);
...
void
convert_dds_message_to_ros(
  const __dds_msg_type_TeleportRelative_Response & dds_message,
  __ros_msg_type_TeleportRelative_Response & ros_message)
{
  // member.name structure_needs_at_least_one_member
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_turtlesim
const char *
take__TeleportRelative_Response(
  void * untyped_topic_reader,
  bool ignore_local_publications,
  void * untyped_ros_message,
  bool * taken,
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    __ros_msg_type_TeleportRelative_Response & ros_message = *static_cast<__ros_msg_type_TeleportRelative_Response *>(untyped_ros_message);
    convert_dds_message_to_ros(dds_messages[0], ros_message);
    *taken = true;
  } else {
    *taken = false;
  ...
  void * untyped_serialized_data)
{
  ...
  DDS::OpenSplice::CdrTypeSupport cdr_ts(__type_support_TeleportRelative_Response);
  DDS::OpenSplice::CdrSerializedData * serdata = nullptr;
...
static message_type_support_callbacks_t TeleportRelative_Response_callbacks = {
  "turtlesim::srv",
...
static rosidl_message_type_support_t TeleportRelative_Response_handle = {
  rosidl_typesupport_opensplice_cpp::typesupport_identifier,
  &TeleportRelative_Response_callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &turtlesim::srv::typesupport_opensplice_cpp::TeleportRelative_Response_handle;
}
...
template<>
class Sample<turtlesim::srv::dds_::TeleportRelative_Request_>
  : public turtlesim::srv::dds_::Sample_TeleportRelative_Request_
{
public:
  turtlesim::srv::dds_::TeleportRelative_Request_ & data()
  {
    return request_;
  }
};
...
template<>
class TemplateDataReader<turtlesim::srv::dds_::Sample_TeleportRelative_Request_>
  : public turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader
{
public:
  static const char * take_sample(
    DDS::DataReader * datareader,
    Sample<turtlesim::srv::dds_::TeleportRelative_Request_> & sample,
    bool * taken)
  noexcept
  {
    turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader * typed_datareader = _narrow(datareader);

    turtlesim::srv::dds_::Sample_TeleportRelative_Request_Seq dds_messages;
    DDS::SampleInfoSeq sample_infos;
    ...
    switch (status) {
      case DDS::RETCODE_ERROR:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader.take failed with: "
               "an internal error has occurred";
      case DDS::RETCODE_ALREADY_DELETED:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader.take failed with: "
               "this turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader has already been deleted";
      case DDS::RETCODE_OUT_OF_RESOURCES:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader.take failed with: "
               "out of resources";
      case DDS::RETCODE_NOT_ENABLED:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader.take failed with: "
               "this turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader is not enabled";
      case DDS::RETCODE_PRECONDITION_NOT_MET:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader.take failed with: "
               "a precondition is not met, one of: "
               "max_samples > maximum and max_samples != LENGTH_UNLIMITED, or "
    ...
    *taken = (sample_infos.length() > 0 && sample_infos[0].valid_data);
    if (*taken) {
      sample = reinterpret_cast<Sample<turtlesim::srv::dds_::TeleportRelative_Request_> &>(dds_messages[0]);
    }
    status = typed_datareader->return_loan(dds_messages, sample_infos);
    switch (status) {
      case DDS::RETCODE_ERROR:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader.return_loan failed with: "
               "an internal error has occurred";
      case DDS::RETCODE_ALREADY_DELETED:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader.return_loan failed with: "
               "this turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader has already been deleted";
      ...
      case DDS::RETCODE_PRECONDITION_NOT_MET:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader.return_loan failed with: "
               ...
               "the data_values and info_seq do not belong to a single related pair, or "
               "the data_values and info_seq were not obtained from this "
               "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader";
      case DDS::RETCODE_OK:
        break;
      default:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataReader.return_loan failed with "
...
template<>
class TemplateDataReader<Sample<turtlesim::srv::dds_::TeleportRelative_Request_>>
  : public TemplateDataReader<turtlesim::srv::dds_::Sample_TeleportRelative_Request_>
{
};

template<>
class TemplateDataWriter<turtlesim::srv::dds_::Sample_TeleportRelative_Request_>
  : public turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter
{
public:
  ...
  noexcept
  {
    turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter * typed_datawriter = _narrow(datawriter);

    DDS::ReturnCode_t status = typed_datawriter->write(sample, DDS::HANDLE_NIL);
    switch (status) {
      case DDS::RETCODE_ERROR:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter.write: "
               "an internal error has occurred";
      case DDS::RETCODE_BAD_PARAMETER:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter.write: "
               "bad handle or instance_data parameter";
      case DDS::RETCODE_ALREADY_DELETED:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter.write: "
               "this turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter has already been deleted";
      case DDS::RETCODE_OUT_OF_RESOURCES:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter.write: "
               "out of resources";
      case DDS::RETCODE_NOT_ENABLED:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter.write: "
               "this turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter is not enabled";
      case DDS::RETCODE_PRECONDITION_NOT_MET:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter.write: "
               "the handle has not been registered with this "
               "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter";
      case DDS::RETCODE_TIMEOUT:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter.write: "
               "writing resulted in blocking and then exceeded the timeout set by the "
               "max_blocking_time of the ReliabilityQosPolicy";
      case DDS::RETCODE_OK:
        return nullptr;
      default:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_DataWriter.write: unknown return code";
    }
  }
};

template<>
class TemplateDataWriter<Sample<turtlesim::srv::dds_::TeleportRelative_Request_>>
  : public TemplateDataWriter<turtlesim::srv::dds_::Sample_TeleportRelative_Request_>
{
};

template<>
class Sample<turtlesim::srv::dds_::TeleportRelative_Response_>
  : public turtlesim::srv::dds_::Sample_TeleportRelative_Response_
{
public:
  turtlesim::srv::dds_::TeleportRelative_Response_ & data()
  {
    return response_;
  }
};
...
template<>
class TemplateDataReader<turtlesim::srv::dds_::Sample_TeleportRelative_Response_>
  : public turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader
{
public:
  static const char * take_sample(
    DDS::DataReader * datareader,
    Sample<turtlesim::srv::dds_::TeleportRelative_Response_> & sample,
    bool * taken)
  noexcept
  {
    turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader * typed_datareader = _narrow(datareader);

    turtlesim::srv::dds_::Sample_TeleportRelative_Response_Seq dds_messages;
    DDS::SampleInfoSeq sample_infos;
    DDS::ReturnCode_t status = typed_datareader->take(
      dds_messages,
      sample_infos,
    ...
    switch (status) {
      case DDS::RETCODE_ERROR:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader.take failed with: "
               "an internal error has occurred";
      case DDS::RETCODE_ALREADY_DELETED:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader.take failed with: "
               "this turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader has already been deleted";
      case DDS::RETCODE_OUT_OF_RESOURCES:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader.take failed with: "
               "out of resources";
      case DDS::RETCODE_NOT_ENABLED:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader.take failed with: "
               "this turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader is not enabled";
      case DDS::RETCODE_PRECONDITION_NOT_MET:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader.take failed with: "
               "a precondition is not met, one of: "
               "max_samples > maximum and max_samples != LENGTH_UNLIMITED, or "
    ...
    *taken = (sample_infos.length() > 0 && sample_infos[0].valid_data);
    if (*taken) {
      sample = reinterpret_cast<Sample<turtlesim::srv::dds_::TeleportRelative_Response_> &>(dds_messages[0]);
    }
    status = typed_datareader->return_loan(dds_messages, sample_infos);
    switch (status) {
      case DDS::RETCODE_ERROR:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader.return_loan failed with: "
               "an internal error has occurred";
      case DDS::RETCODE_ALREADY_DELETED:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader.return_loan failed with: "
               "this turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader has already been deleted";
      ...
      case DDS::RETCODE_PRECONDITION_NOT_MET:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader.return_loan failed with: "
               ...
               "the data_values and info_seq do not belong to a single related pair, or "
               "the data_values and info_seq were not obtained from this "
               "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader";
      case DDS::RETCODE_OK:
        break;
      default:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataReader.return_loan failed with "
...
template<>
class TemplateDataReader<Sample<turtlesim::srv::dds_::TeleportRelative_Response_>>
  : public TemplateDataReader<turtlesim::srv::dds_::Sample_TeleportRelative_Response_>
{
};

template<>
class TemplateDataWriter<turtlesim::srv::dds_::Sample_TeleportRelative_Response_>
  : public turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter
{
public:
  static const char * write_sample(
    DDS::DataWriter * datawriter,
  ...
  noexcept
  {
    turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter * typed_datawriter = _narrow(datawriter);

    DDS::ReturnCode_t status = typed_datawriter->write(sample, DDS::HANDLE_NIL);
    switch (status) {
      case DDS::RETCODE_ERROR:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter.write: "
               "an internal error has occurred";
      case DDS::RETCODE_BAD_PARAMETER:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter.write: "
               "bad handle or instance_data parameter";
      case DDS::RETCODE_ALREADY_DELETED:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter.write: "
               "this turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter has already been deleted";
      case DDS::RETCODE_OUT_OF_RESOURCES:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter.write: "
               "out of resources";
      case DDS::RETCODE_NOT_ENABLED:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter.write: "
               "this turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter is not enabled";
      case DDS::RETCODE_PRECONDITION_NOT_MET:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter.write: "
               "the handle has not been registered with this "
               "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter";
      case DDS::RETCODE_TIMEOUT:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter.write: "
               "writing resulted in blocking and then exceeded the timeout set by the "
               "max_blocking_time of the ReliabilityQosPolicy";
      case DDS::RETCODE_OK:
        return nullptr;
      default:
        return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_DataWriter.write: unknown return code";
    }
  }
};

template<>
class TemplateDataWriter<Sample<turtlesim::srv::dds_::TeleportRelative_Response_>>
  : public TemplateDataWriter<turtlesim::srv::dds_::Sample_TeleportRelative_Response_>
{
};
...
const char *
register_types__TeleportRelative(
  void * untyped_participant, const char * request_type_name, const char * response_type_name)
{
  ...
  turtlesim::srv::dds_::Sample_TeleportRelative_Request_TypeSupport ros_request_ts;
  DDS::ReturnCode_t status = ros_request_ts.register_type(participant, request_type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_TypeSupport.register_type: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_TypeSupport.register_type: "
             "bad domain participant or type name parameter";
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      return "turtlesim::srv::dds_::Sample_TeleportRelative_Request_TypeSupport.register_type: unkown return code";
  }

  turtlesim::srv::dds_::Sample_TeleportRelative_Response_TypeSupport ros_response_ts;
  status = ros_response_ts.register_type(participant, response_type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_TypeSupport.register_type: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_TypeSupport.register_type: "
             "bad domain participant or type name parameter";
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      return "turtlesim::srv::dds_::Sample_TeleportRelative_Response_TypeSupport.register_type: unkown return code";
  }
  return nullptr;
}
  ...
  void * (*allocator)(size_t))
{
  ...
  const std::string service_type_name("turtlesim::srv::dds_::Sample_TeleportRelative");
  const std::string request_type_name("turtlesim::srv::dds_::Sample_TeleportRelative_Request_");
  const std::string response_type_name("turtlesim::srv::dds_::Sample_TeleportRelative_Response_");
  ...
  const char * error_string = register_types__TeleportRelative(
...
const char *
create_responder__TeleportRelative(
  void * untyped_participant, const char * service_name,
  ...
  void * untyped_requester, const void * untyped_ros_request, int64_t * sequence_number)
{
  ...
  using ROSRequestT = turtlesim::srv::TeleportRelative_Request;
...
{
  using ROSResponseT = turtlesim::srv::TeleportRelative_Response;
...
const char *
destroy_requester__TeleportRelative(void * untyped_requester, void (* deallocator)(void *))
{
  using RequesterT = rosidl_typesupport_opensplice_cpp::Requester<
    turtlesim::srv::dds_::TeleportRelative_Request_,
    turtlesim::srv::dds_::TeleportRelative_Response_
...
const char *
destroy_responder__TeleportRelative(void * untyped_responder, void (* deallocator)(void *))
{
  using ResponderT = rosidl_typesupport_opensplice_cpp::Responder<
    turtlesim::srv::dds_::TeleportRelative_Request_,
    turtlesim::srv::dds_::TeleportRelative_Response_
...
const char *
server_is_available__TeleportRelative(
...
static service_type_support_callbacks_t TeleportRelative_callbacks = {
  "turtlesim::srv",
  "TeleportRelative",
  &create_requester__TeleportRelative,
  &destroy_requester__TeleportRelative,
  &create_responder__TeleportRelative,
  &destroy_responder__TeleportRelative,
  &send_request__TeleportRelative,
  &take_request__TeleportRelative,
  &send_response__TeleportRelative,
  &take_response__TeleportRelative,
...
static rosidl_service_type_support_t TeleportRelative_handle = {
  rosidl_typesupport_opensplice_cpp::typesupport_identifier,
  &TeleportRelative_callbacks,
...
{
  return &turtlesim::srv::typesupport_opensplice_cpp::TeleportRelative_handle;
}
