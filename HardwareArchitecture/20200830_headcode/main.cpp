...
Serial deb_u(PD_8,PD_9,1000000);
...
Myencoder encoder[4]={PC_3,PF_9,PF_7,PF_5};//(A0,A1,A2,A4);
Motor top_motor(PF_12,PF_11,PA_1);
Motor neck_motor(PE_12,PE_11,PB_15); // true
Motor left_motor(PG_1,PG_0,PA_2);
Motor right_motor(PE_9,PE_8,PB_14);
