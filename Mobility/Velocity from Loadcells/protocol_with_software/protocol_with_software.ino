...
//  Serial.println("#");
  ...
  float M = Magnitude(A*pow(data1,2), A*pow(data2,2) , A*pow(data3,2), A*pow(data4,2), A*pow(data5,2), A*pow(data6,2), A*pow(data7,2), A*pow(data8,2));
//  float M = Magnitude((data1*7), (data2*7) , (data3*7), (data4*7), (data5*7), (data6*7), (data7*7), (data8*7));
  ...
  buffers[2] = int_x>>8;
  if(sumx<0){
    buffers[2]|=0b10000000;
  }
  buffers[3] = int_x%256;
  buffers[4] = int_y>>8;
   if(sumy<0){
    buffers[4]|=0b10000000;
  }
  buffers[5] = int_y%256;
...
long FindZeroFactor1()
{
  ...
  scale1.set_scale();
  scale1.tare();
  long zero_factor = scale1.read_average(5);
...
long FindZeroFactor2()
{
  ...
  scale2.set_scale();
  scale2.tare();
  long zero_factor2 = scale2.read_average(5);
  //Serial.print("Zero factor: ");
  //Serial.println(zero_factor);
  return (zero_factor2);
}
long FindZeroFactor3()
{
  ...
  scale3.set_scale();
  scale3.tare();
  long zero_factor3 = scale3.read_average(5);
  //Serial.print("Zero factor: ");
  //Serial.println(zero_factor);
  return (zero_factor3);
}
long FindZeroFactor4()
{
  scale4.set_scale();
  scale4.tare();
  long zero_factor4 = scale4.read_average(5);
  return (zero_factor4);
}
long FindZeroFactor5()
{
  scale5.set_scale();
  scale5.tare();
  long zero_factor5 = scale5.read_average(5);
  return (zero_factor5);
}
long FindZeroFactor6()
{
  scale6.set_scale();
  scale6.tare();
  long zero_factor6 = scale6.read_average(5);
  return (zero_factor6);
}
long FindZeroFactor7()
{
  scale7.set_scale();
  scale7.tare();
  long zero_factor7 = scale7.read_average(5);
  return (zero_factor7);
}
long FindZeroFactor8()
{
  scale8.set_scale();
  scale8.tare();
  long zero_factor8 = scale8.read_average(5);
  return (zero_factor8);
}
/////////////////////////////////////////////////////////////////////////////
