...
if("TRUE" STREQUAL "TRUE")
  set(mrpt_ekf_slam_3d_SOURCE_PREFIX /home/xprize/Bally_Workspace/src/mrpt_slam/mrpt_ekf_slam_3d)
  set(mrpt_ekf_slam_3d_DEVEL_PREFIX /home/xprize/Bally_Workspace/devel)
  ...
  set(mrpt_ekf_slam_3d_INSTALL_PREFIX /home/xprize/Bally_Workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mrpt_ekf_slam_3d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xprize/Bally_Workspace/src/mrpt_slam/mrpt_ekf_slam_3d/${idir}'.  ${_report}")
    endif()
